...
..\..\..\..\..\Tools\OTAUtils\JET.exe -m combine -f Light.bin -x configOTA_6x_Cer_Keys_HA_Light.txt -v 4 -g 1 -k 0xffffffffffffffffffffffffffffffff -u 0x1037 -t 0x1101

:: Creat an Unencrpted Bootable Client with Veriosn 1
..\..\..\..\..\Tools\OTAUtils\JET.exe -m otamerge --embed_hdr -c outputffffffffffffffff.bin -o Client.bin -v 4 -n 1 -u 0x1037 -t 0x1101
...
..\..\..\..\..\Tools\OTAUtils\JET.exe -m otamerge --embed_hdr -c Client.bin -o UpGradeImagewithOTAHeaderV2.bin -v 4 -n 2 -u 0x1037 -t 0x1101
...
..\..\..\..\..\Tools\OTAUtils\JET.exe -m otamerge --ota -c UpGradeImagewithOTAHeaderV2_Enc.bin -o Client_UpgradeImagewithOTAHeaderV2_Enc.bin -v 4 -n 2 -u 0x1037 -t 0x1101


:: Modify Embedded Header to reflect version 3 
..\..\..\..\..\Tools\OTAUtils\JET.exe -m otamerge --embed_hdr -c Client.bin -o UpGradeImagewithOTAHeaderV3.bin -v 4 -n 3 -u 0x1037 -t 0x1101
...
..\..\..\..\..\Tools\OTAUtils\JET.exe -m otamerge --ota -c UpGradeImagewithOTAHeaderV3_Enc.bin -o Client_UpgradeImagewithOTAHeaderV3_Enc.bin -v 4 -n 3 -u 0x1037 -t 0x1101
