...
PRIVATE pdum_tsAPduInstance s_asapduZDPInstances[16] = {
...
PRIVATE pdum_tsAPduInstance s_asapduZCLInstances[15] = {
...
PRIVATE pdum_tsAPdu s_asAPduPool[2] = {
    { s_asapduZDPInstances, 0, 100, 16},
    { s_asapduZCLInstances, 0, 100, 15},
};
