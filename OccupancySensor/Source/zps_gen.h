...
#define ZPS_NODE_OCCUPANCYSENSOR
...
#define DIMMABLELIGHT_GREENPOWER_ENDPOINT    (242)
...
#define COLORTEMPTUNABLEWHITELIGHT_GREENPOWER_ENDPOINT    (242)
...
#define COLORDIMMABLELIGHT_GREENPOWER_ENDPOINT    (242)
