...
PRIVATE pdum_tsAPduInstance s_asapduZDPInstances[3] = {
...
PRIVATE pdum_tsAPduInstance s_asapduZCLInstances[10] = {
...
PRIVATE pdum_tsAPdu s_asAPduPool[2] = {
    { s_asapduZDPInstances, 0, 100, 3},
    { s_asapduZCLInstances, 0, 100, 10},
};
